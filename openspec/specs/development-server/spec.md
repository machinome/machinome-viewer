...
or the missing-bundle remedy in its error pane. An installation whose
development app is not built SHALL answer the page with the build remedy while
keeping every other route available.
