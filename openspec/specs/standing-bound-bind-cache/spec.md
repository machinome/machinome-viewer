# standing-bound-bind-cache Specification

## Purpose

Retain exact successful standing expression work between determined running Bound searches, without changing their sampled motion or public state.
