# Minimal path-input retention Specification

## Purpose

Reconstruct a followed expression's bound piece after an expression-table reset without retaining unrelated running-bank coordinates.
