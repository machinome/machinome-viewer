# kink-probe-throughput Specification

## Purpose

Preserve complete running-machine outcomes while avoiding repeated deterministic expression evaluation inside one kink-cut search of a current mechanical project.
