# Running target endpoint Specification

## Purpose

Preserve an absolute running request's authored native destination through unobstructed final admission, physical-stop judgment, and snapshot replay without changing the intermediate path or relative requests.
