...
- [ADR-015: FastAPI + Uvicorn as Unified Stack for HTTP-Based Services](https://github.com/LibreSolid/solid-node/blob/main/docs/adrs/IPC/ADR-015-fastapi-unified-stack-for-http-services.md)
