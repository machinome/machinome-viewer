...
.. note::
   ...
   This manual describes the **unreleased** |package-version| source version,
   viewer API |viewer-api|. The independent package has not yet been published.
   Follow :doc:`installation` for a matching source installation.
