...
- [ADR-066](EXPORT/ADR-066-a-gesture-is-drawn-at-the-declared-tempo.md) — A gesture is drawn at the tempo its input's declared instruction states — **Accepted**, amends 065, extends 064
